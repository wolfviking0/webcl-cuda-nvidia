...
CFLAGS = -s OPT_LEVEL=1 -s DEBUG_LEVEL=1 -s CU_PRINT_TRACE=1 -s WARN_ON_UNDEFINED_SYMBOLS=1 -s CU_DEBUG=1 -s CU_GRAB_TRACE=1 -s CU_CHECK_VALID_OBJECT=1
else
$(info ************ EMSCRIPTEN : DEBUG         = 0 ************)

CFLAGS = -s OPT_LEVEL=3 -s DEBUG_LEVEL=0 -s CU_PRINT_TRACE=0 -s DISABLE_EXCEPTION_CATCHING=0 -s WARN_ON_UNDEFINED_SYMBOLS=1 -s CU_DEBUG=0 -s CU_GRAB_TRACE=0 -s CU_CHECK_VALID_OBJECT=0
endif
