...
DEBUG = -s OPT_LEVEL=1 -s DEBUG_LEVEL=1 -s DISABLE_EXCEPTION_CATCHING=0 -s WARN_ON_UNDEFINED_SYMBOLS=1 -s CU_DEBUG=1 -s CU_GRAB_TRACE=1 -s CU_PRINT_TRACE=1 

NO_DEBUG = -s OPT_LEVEL=2 -s DEBUG_LEVEL=0 -s WARN_ON_UNDEFINED_SYMBOLS=0  -s CU_DEBUG=0 -s CU_GRAB_TRACE=0 -s CU_PRINT_TRACE=0
